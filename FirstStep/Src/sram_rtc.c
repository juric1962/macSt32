...
// static RAM vs AVR EEPROM
__no_init backup_data_t __eeprom @ 0x40024000;
//------------------------ RTC ------------------------------------------------- 
...
{  
  ...
  if(ms>1000) // ������ 1 �������, ��� ���� 1 ��
  {  
    if(chrep.writeAccess)chrep.writeAccess--; // ������ ���������� ������ ������������� ���� ���������������
    oneSec=1;
    systemTimeUpdate();
    fixfreqTask();//fixfreqTask(); // ���������� �������� ������� ������ ����������� ������������ �������� �������
...
{ 
  ...
  {    
    *eventRecordPtr=0;  
    if(systemState.eventLogHardwareFault==2)eventLogWrite(18); // ������ ������������� ���������� ���������� ����������   
    systemState.eventLogHardwareFault=1; // ������ ������ ��������� �����
    eventLogWrite(18);     
...
{   
  ...
  case 10: // �������� ���
    ...
    case 116: // �������� ������ �� ������ �16     
      ...
      eventRecord[*eventRecordPtr].fld.reg[0]=(tapRecord.fld.intervalMin)&0xFFF;//+((tapRecord.fld.tapNum<<4)&0xF000); - ���� �� ������ 
...
{ 
  ...
  if((*activePower.totalSumCRC)!=modBusCRC16((uint8_t*)activePower.totalSum,8)) // ����� �� ����������� ��� ���������� �������
  {     
    *activePower.totalSum=0;    
    *activePower.totalSumCRC=modBusCRC16((uint8_t*)activePower.totalSum,8);
    systemState.eventLogHardwareFault=15; // ������� ������� �������� �������
    eventLogWrite(18);     
  }   
}
...
{  
  double tempDouble;
  if(activePower.secondsSumRdy) // ����� ���� ����������� ������ �� ���������� �������, �.�. ����������� ���������� ������� ������ ������������ 
  {                 // ����������� ����� ��������� �������� � �������� RTC
    activePower.secondsSumRdy=0;	
    tempDouble=(double)activePower.secondsSum/((double)(engine.freqPWM));
    activePower.infiniteSum+=(uint32_t)tempDouble; // ��������� ������� � ���*���	
